<?php
    ...
    $query = "SELECT * FROM cabang where kota_cabang='$_SESSION[kota]'";
    ...
    if(isset($_POST['btnselect'])){
        $id = $_POST['btnselect'];
        header("Location: ShowListFilm.php?cabang=$id");
    }
?>
<!doctype html>
<html lang="en">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo"<button class='btn btn-primary' type ='submit' value ='$value[id_cabang]' name ='btnselect'><i class='fas fa-check'></i></button>"?></td>
                            </tr>
                            <?php
                              }
                             ?>
