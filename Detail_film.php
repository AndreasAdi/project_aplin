            ...
            <form method='post'>
                ...
                if (!isset($_SESSION['email'])) {
                   ...
                   <a href='Ticketing.php'> <button class = 'btn btn-success' type ='button'>Login</button> </a>";
                    ...
                    echo "<button class = 'btn btn-danger ml-4' name='btn_logout'>Logout</button>";
                }
                ?>
            </form>
        </div>
    ...
    <div class="container text-light">
        ...
        <div class="row">
            ...
            <div class="col-7 mt-5">
                ...
                <div class="mt-5 mb-5">
                    <button class="btn btn-warning pt-2" type="button" id="btnbook" data-toggle="modal" data-target="#modalseat">
        ...
        $(document).ready(function() {
            ...
            $("#btnbook").click(function () {
                $.ajax({
                    ...
                    url: "ceklogin.php", // tujuan request
                    data: {
                    }, // data yang dikirim
                    success: function(res) {
                        ...
                        if (res == 'sudah') {
                            ...
                            location.replace("ticketing.php");
                        }
                    }
                });   
              })
